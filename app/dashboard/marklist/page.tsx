...
import { formatGradeWithPoints, getPerformanceLevelWithPoints, getGradeLevelByClass, getLevelByTotalPoints, getLevelByAverageMark, getLevelByTotalMarksRange, getGradingScale } from '@/lib/grading-utils'
                                ...
                                {currentSchool?.feature_whatsapp_reports && result.learner.parent_phone && (
                                  <Button 
                                    ...
                                    onClick={() => {
                                      ...
                                      const gradeInfo = getLevelByTotalMarksRange(result.total)
                        ...
                        <table className="w-full text-sm">
                          ...
                          <tbody>
                            {topPerformers.map((r, i) => {
                              const performanceLevel = getLevelByTotalMarksRange(r.total)
                              return (
                        ...
                        <Button size="sm" variant="outline" onClick={() => attemptPrint(() => {
                          try {
                            ...
                            const tableRows = combinedMarklistData.learners.map((learner, idx) => {
                              ...
                              const overallLevel = getLevelByTotalMarksRange((learner as any).total ?? 0)?.level || '-'
