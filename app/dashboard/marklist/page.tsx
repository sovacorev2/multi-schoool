                ...
                <tr className="bg-slate-200 dark:bg-slate-700">
                  ...
                  {subjects.map((subject) => (
                    <React.Fragment key={`header-${subject.id}`}>
                      ...
                      <th className="border border-border dark:border-border p-2 font-bold text-xs" style={{ color: '#1a3a52' }}>
                        Level
                      </th>
                    ...
                    {subjects.map((subject) => {
                      ...
                      return (
                        <React.Fragment key={subject.id}>
                          ...
                          <td className="border border-border dark:border-border p-2 text-center font-bold" style={{ color: '#1a3a52' }}>
                  ...
                  {subjects.map((subject) => {
                    ...
                    return (
                      <React.Fragment key={`mean-${subject.id}`}>
                        ...
                        <td className="border border-border dark:border-border p-2 text-center text-sm font-bold" style={{ color: '#1a3a52' }}>
