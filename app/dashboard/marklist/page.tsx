                                    ...
                                    onClick={async () => {
                                      ...
                                      try {
                                        const res = await fetch('/api/send-sms', {
                                          ...
                                          body: JSON.stringify({ mobile: result.learner.parent_phone, message, schoolId: currentSchool?.id })
                                        })
                                        const data = await res.json()
                                        if (res.status === 402) alert(`Insufficient SMS credits: ${data.error}. Purchase more in the admin portal.`)
